...
class Config:
    ...
    # 11.08 по его слову «три секунды — это много»: опущено с 3.0 до 2.5.
    # Обмен прямой: пауза перед ответом короче на треть, но раздумье длиннее
    # двух с половиной секунд теперь режется.
    TURN_MAX_WAIT: float = float(os.getenv("TURN_MAX_WAIT", "2.5"))
