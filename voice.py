...
def _tts_clean(text: str, language: str = "ru") -> str:
    ...
    # 16.08: он слышал «сто двадцать шесть градусов» и «сто пятьдесят км/ч».
    # Причина: index.html объявлен <html lang="en">, язык страницы уходит в
    # сессию, и русский ответ чистился английской веткой — «12,7 °C» и
    # «км/ч» оставались сырыми, голос читал запятую как ничто.
    # Теперь: есть кириллица — обрабатываем по-русски, кто бы что ни объявил.
    if language != "ru" and re.search(r"[а-яёА-ЯЁ]", t):
        language = "ru"
...
async def voice_health():
    ...
    return {
        ...
        "сборка": "2026-08-16 словарь-таймер",
        "llm": current_model(),
        "stt": "Deepgram Nova-3",
